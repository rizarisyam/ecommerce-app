<template>
  ...
  >
    <div class="flex w-full">
      <div class="flex h-full justify-center flex-col w-full">
        <svg
      ...
      >
        ...
        <ul aria-orientation="vertical" class="rounded py-8 w-32">
          <li
            class="
              cursor-pointer
              text-indigo-700 text-sm
          ...
          >
            ...
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="h-4 feather feather-arrow-down"
            >
            ...
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="h-4 feather feather-arrow-up"
            >
          ...
          <li>
            <div v-if="isDropdownOpen" class="bg-gray-50 px-2">
              <ul>
                <li
                  class="
                    text-gray-600 text-sm
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="w-4 mr-2 feather feather-disc"
                  >
